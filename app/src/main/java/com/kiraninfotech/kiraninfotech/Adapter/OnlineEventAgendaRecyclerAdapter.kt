...
class OnlineEventAgendaRecyclerAdapter(val context: Context, val arrEventAgenda : ArrayList<String>): RecyclerView.Adapter<OnlineEventAgendaRecyclerAdapter.ViewHolder>() {
